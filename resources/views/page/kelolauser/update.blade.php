                    ...
                    <form method="POST" action="{{ route('kelolauser.update', $user->id) }}">
                        ...
                        <div class="mb-3 form-role-user">
                            ...
                            <select id="role" class="form-select" name="role">
                                ...
                                <option value="2" {{ $user->role == 2 ? 'selected' : '' }}>Petugas Arsip</option>
                                <option value="3" {{ $user->role == 3 ? 'selected' : '' }}>Kepala Subseksi</option>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="fullname" placeholder="John Doe"
                                    aria-label="John Doe" aria-describedby="fullname2" name="fullname"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="username" class="form-control" placeholder="jhondoe2"
                                    aria-label="jhondoe2" aria-describedby="username2" name="username"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="email" class="form-control" placeholder="john.doe"
                                    aria-label="john.doe" aria-describedby="email2" name="email"
